...
while True:
    if x == 1 and y == 1:
        ...
        y += 1
    if x== 1 and y == 2:
        print('You can tavel: (N)orth or (E)ast or (S)outh.')
        att = input('Direction: ')
        if att == 'w' or att == 'W':
            print('Not a valid direction!')
            continue
        if att == 'n' or att == 'N':
            ...
            y -= 1
    if x== 2 and y == 2:
        print('You can tavel: (S)outh or (W)est.')
        att = input('Direction: ')
    ...
    if x== 2 and y == 1:
        ...
        y += 1
    if x== 1 and y == 3:
        print('You can tavel: (E)ast or (S)outh.')
        att = input('Direction: ')
        ...
        if att == 'e' or att == 'E':
            ...
            y -= 1
    if x== 2 and y == 3:
        print('You can tavel: (E)ast or (W)est.')
        att = input('Direction: ')
